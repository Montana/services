...
const  _ = require('lodash'),
  ...
  { LabShareNotifications } = require('@niaid/services-notifications'),
  { LabShareLogger } = require('@niaid/services-logger'),
...
class Services {
  ...
  async start() {
    ...
    lb4ProxyApp.bind("errorHook").to((error, logger) => this._onRESTError ? this._onRESTError(error, logger) : false);
